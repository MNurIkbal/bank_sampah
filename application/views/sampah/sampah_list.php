<div class="row" style="margin-bottom: 10px">
    <div class="col-md-4">
        <?php echo anchor(site_url('sampah/create'), 'Tambah', 'class="btn btn-primary"'); ?>
    </div>
    ...
    <tr>
        ...
        <tr>
            ...
            <td style="text-align:center" width="200px">
                ...
                echo anchor(site_url('sampah/update/' . $sampah->id_sampah), '<span class="label label-info">Edit</span>');
                echo ' | ';
                echo anchor(site_url('sampah/delete/' . $sampah->id_sampah), '<span class="label label-danger">Hapus</span>', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                ?>
            </td>
        </tr>
    <?php
